  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        premium: "bg-gradient-to-r from-nyxara-primary to-nyxara-secondary text-white hover:from-nyxara-primary/90 hover:to-nyxara-secondary/90 shadow-lg hover:shadow-xl hover:scale-105",
        gradient: "bg-gradient-to-r from-purple-600 to-pink-600 text-white hover:opacity-90 hover:shadow-xl",
      },
      size: {
